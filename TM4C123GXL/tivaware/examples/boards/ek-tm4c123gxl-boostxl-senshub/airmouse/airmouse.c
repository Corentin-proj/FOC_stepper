...
main(void)
{
    ...
    //
    MAP_SysCtlClockSet(SYSCTL_SYSDIV_5 | SYSCTL_USE_PLL | SYSCTL_OSC_MAIN |
                       SYSCTL_XTAL_16MHZ);
    ...
    MAP_IntPrioritySet(INT_GPIOB, 0x10);
    MAP_IntPrioritySet(FAULT_SYSTICK, 0x20);
    MAP_IntPrioritySet(INT_UART1, 0x60);
    MAP_IntPrioritySet(INT_UART0, 0x70);
    MAP_IntPrioritySet(INT_WTIMER5B, 0x80);
