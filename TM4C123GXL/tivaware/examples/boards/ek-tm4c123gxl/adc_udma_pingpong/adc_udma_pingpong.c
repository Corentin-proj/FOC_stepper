//*****************************************************************************
//
// adc_udma_pingpong.c - ADC Sampling with Timer Trigger and using uDMA
//                       Ping-Pong Mode for transfers to memory buffers.
//
...
//! <h1>ADC with Timer Trigger and uDMA transfer Demo (adc_udma_pingpong)</h1>
//!
